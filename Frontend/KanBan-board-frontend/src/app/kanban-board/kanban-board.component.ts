...
export class KanbanBoardComponent implements OnInit {
  ...
  // goToUpdateTask(task : CreateTask){
  // //   this.router.navigate(['/kanban-board/update-task', task._id])
  // // [routerLink]="['/kanban-board/update-task', task._id]" 
  // this.projectService.taskData = task;
  // this.router.navigate(['/kanban-board/update-task', this.tasks._id])
